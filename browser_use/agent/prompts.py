...
class SystemPrompt:
    ...
    def _load_prompt_template(self) -> None:
        ...
        try:
            ...
            with importlib.resources.files("browser_use.agent").joinpath(
                template_filename
...
class AgentMessagePrompt:
    ...
    def _get_browser_state_description(self) -> str:
        ...
        if self.browser_state.page_info:
            ...
            _current_page_position = pi.scroll_y / max(
                pi.page_height - pi.viewport_height, 1
            )
